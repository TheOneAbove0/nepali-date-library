...
console.log(`
// Copy into js/src/data.ts

// ------ TO UPDATE THESE HARDCODED VALUES USE /scripts/encode-days-in-month.js
// We have defined our own Epoch for Nepali BS: ${yearZero}-1-1 BS or ${bsEpoch} AD
export const BS_EPOCH_TS = ${bsEpochTs}; // = Date.parse('${bsEpoch}')
export const BS_YEAR_ZERO = ${yearZero};
export const ENCODED_MONTH_LENGTHS = [
  ${encodedLengths.join(',')}
] as const;
`);
