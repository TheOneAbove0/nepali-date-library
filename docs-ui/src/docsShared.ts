import type { NepaliDatePickerStyles, NepaliDatePickerValue, NepaliDatePickerVariables } from 'nepali-date-library-react';
import { toBik, type BsDate } from 'nepali-date-library';

export const sampleAd = '2026-05-13';
export const sampleBs = toBik(sampleAd);
